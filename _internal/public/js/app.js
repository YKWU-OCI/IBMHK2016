...
app.controller('claimCtrl', ['$rootScope', '$scope', '$http', function($rootScope, $scope, $http){
	$scope.claim = function(){
		...
		var req = {
			method: 'POST',
			url: "/check_claim",
			data: {_id: $scope._id, name: $scope.name, hkid: $scope.hkid, amount: $scope.amount, claim_amount: $scope.claim_amount, company: $("#company").val()}
		}
